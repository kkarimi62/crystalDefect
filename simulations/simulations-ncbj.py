...
if __name__ == '__main__':
        ...
        def SetVariables():
            Variable = {
                    ...
                    15:' -var buff 0.0 -var T 2000.0 -var P 0.0 -var time 100000.0 -var nevery 10000 -var DumpFile dumpThermalized.xyz -var WriteData lammps_data.dat -var rnd %s -var rnd1 %s'%tuple(np.random.randint(1001,9999,size=2)),
