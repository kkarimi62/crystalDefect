...
if __name__ == '__main__':
        ...
        def SetVariables():
            Variable = {
                    ...
                    5:' -var buff 0.0 -var nevery 1000 -var ParseData 0 -var lx 5 -var ly 5 -var lz 5 -var ntype 2 -var cutoff 3.54  -var DumpFile dumpMin.xyz -var WriteData lammps_data.dat -var seed0 %s -var seed1 %s -var seed2 %s -var seed3 %s'%tuple(np.random.randint(1001,9999,size=4)), 
                    ...
                    'p4':' lammps_data.dat lammps_data.dat %s 1 1 0.0'%(os.getcwd()+'/lmpScripts'),
