...
if __name__ == '__main__':
        ...
        def SetVariables():
            Variable = {
                    ...
                    7:' -var buff 0.0 -var T 2000.0 -var P 0.0 -var nevery 1000 -var ParseData 1 -var DataFile data_minimized.dat -var DumpFile dumpThermalized.xyz -var WriteData lammps_data.dat -var rnd %s'%np.random.randint(1001,9999),
