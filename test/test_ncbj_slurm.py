...
#
    ...
    nThreads             = 1
    jobname              = {
                            '4':'descriptors/ni/pure/shape14x14x14_increasedCutoff_localized',#'descriptors/ni/pure/test', 
                            '5':'neuralNet/ni/pure/shape14x14x14_increasedCutoff_localized',#shape10x10x10_overfitting_trainSize',#'neuralNet/ni/pure/test', 
                            '6':'mlmc/ni/interestitials/test2nd', 
                            }['5']
    DeleteExistingFolder = True
    readPath             = os.getcwd() + {
                                            '4':'/../simulations/ni/pure/increasedCutoff', #test2nd',
                                            '5':'/descriptors/ni/pure/shape14x14x14_increasedCutoff_localized', #'/descriptors/ni/pure/test',
